...
//		}
	...
	public String getSpecailInitIds() {
		return specailInitIds;
	}

	public void setSpecailInitIds(String specailInitIds) {
		this.specailInitIds = specailInitIds;
	}
	...
	public String tocacheKey() {
		return "memberId=" + memberId + ", imei=" + imei + ", longitude=" + longitude + ", latitude="
				...
				+ noInters + ", contentType=" + contentType + ", orderBy=" + orderBy + ", indexIds=" + indexIds +", specailInitIds=" + specailInitIds +"";
	}
	@Override
