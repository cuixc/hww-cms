...
public class CmsContentServiceImpl implements CmsContentService {
	...
	@Autowired
	private CmsRewriteHtml cmsRewriteHtml;
	...
	public void updateNewWithContent(CmsContentVo cmsContentVo) {
		...
		for (Long id : categoryIds) {
			...
			String linkUrl=cmsServicePrefix+"/pshare/"+id+"/content_"+cmsContentVo.getContentId()+"_0.html";
			last.setLinkUrl(linkUrl);
			last.setSiteId(1);
...
//			cmsNewEsSyncFailService.save(cmsNewEsSyncFail);
	...
	public CmsContent voToEntity(CmsContent entity, CmsContentVo cmsContentVo) {
		...
		if(cmsContentVo.getHiddenMap()!=null){
			entity.setHiddenMap(cmsContentVo.getHiddenMap());
		}
		if(cmsContentVo.getOutLink()!=null){
			entity.setOutLink(cmsContentVo.getOutLink());
		}
		return entity;
	}
	...
	public boolean setCmsPriority(Long contentId, Integer priority) {
		// TODO Auto-generated method stub
		return cmsContentMng.setCmsPriority(contentId, priority);
	}
