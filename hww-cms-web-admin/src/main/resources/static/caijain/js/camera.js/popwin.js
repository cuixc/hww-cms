var frame_popwin_data_key="frame_popwin_data_key";
var popWin = {
    ...
    showWin: function(src, width, height,data, callBackBeforeClose) {
        ...
        this.init();
        if(data){
        	store.set(frame_popwin_data_key,data);
        }
    },
    getParam:function(){
    	return store.get(frame_popwin_data_key);
    },
    clearParam:function(){
    	return store.remove(frame_popwin_data_key);
    },
    mouseClose: function() {
