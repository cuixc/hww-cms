...
////@Transactional
//public class CmsContentServiceImpl_back_2018_0213_2006
//	implements
//		CmsContentService {
//
//	private static final Log log = LogFactory.getLog(CmsContentServiceImpl_back_2018_0213_2006.class);
//
//	@Autowired
...
//		CmsContent cmsContent = cmsContentMng.findOneByContentIdForService(cmsQueryDto.getContentId());
//		if (cmsContent == null || cmsContent.getId() == null) {
//			return null;
//		}
//		CmsContentData cmsContentData = cmsContentDataMng.loadCmsContentDataByContentIdForSerice(cmsQueryDto.getContentId());
...
//						&& val.getManuallySortNum().intValue() <= cmsContentVoList.size()))// 获取有排序字段的新闻,超过链表size的
//																						   // sortnum
//																						   // 直接忽略
//				.sorted((v1, v2) -> {
...
//
//		}
//		log.debug("DDDDDD===dataSource:" + String.join(",", dataSource.stream()
...
//			CmsContentData cmsDataFromSns = cmsContentDataMng.loadCmsContentDataByContentIdForSerice(cmsContentId);
...
//		// vo.getReleaseTime().getTime())/1000/60/60;//小时
//		// time=time==0?1:time;
//		// double timeF=(1D/(time*1.0D));
//		// double
//		// priorityF=(vo.getPriority()==null?1D:vo.getPriority().doubleValue())*0.1;
...
//
//			// List<CmsContentVo> fromAllColumn=Lists.newArrayList();
//			// for(AppRecommConfigDto recomm : recommColumnLists) {//在这里是频道循环
//			// int recommNum
//			// =recomm.getRecommNum()==null?0:recomm.getRecommNum();
...
//						new HCmsQueryDto().setMemberId(queryDto.getMemberId()).setColumnId(columnId).setOrderBy(1)
...
//						}).collect(Collectors.toList());
//					}
//					List<CmsContentVo> voListAfterFilter = filterAndConstructColumnData(finalPutDataCount,
//							contentIdsIndexHaveUsed, contentIdsInReHis, cmsContentVoList);
...
//
//							List<SnsTopicVo> recommTopicList = snsFeignClient
//									.loadTopicByIdsFeginApi(queryFeginApiDto);
...
//		//
//		// List<AppRecommConfigDto> topicRecommList =
//		// recommAllLists.stream().filter(val->val.getType().intValue()==3).collect(Collectors.toList());
//		// if(topicRecommList!=null&&topicRecommList.size()>0) {
//		//
//		// int topicRecommNum=topicRecommList.get(0).getRecommNum();//新鲜事推荐数量
//		// List<SnsTopicVo> recommTopicList =
//		// snsFeignClient.loadRecommTopicsFeginApi(new
//		// HBaseSnsQueryDto().setMemberId(queryDto.getMemberId()).setPageNo(1).setPageSize(topicRecommNum));
//		//
...
//		//
//		// thisTimeRecommendHis.add(new ESRecommendHis( memberId,
//		// imei,3,vo.getTopicId(),1));
//		// contentIdsIndexHaveUsed.add(vo.getTopicId());
//		// }
//		// }
//		// dataListGloble.addAll(dataListForTopic);
//		// long f=System.currentTimeMillis();
//		// log.debug("-----after---dataListForTopic----|t1: +"+(f-e)/1000+"||t2:
//		// "+(f-a)/1000+"");
//		// =============新鲜事推荐结束============================================================================
//
...
//
//	// List<CmsSpecial> spcialList=
//	// cmsSpecialService.loadFirstLeveSpecialList(Short.valueOf("1"));
//	// if(spcialList!=null&&!spcialList.isEmpty()) {
//	// List<CmsSpecial>
//	// recommSpList=spcialList.stream().sorted((v1,v2)->v1.getRecommPriority()-v2.getRecommPriority()).collect(Collectors.toList());
//	// if(recommSpList!=null&&recommSpList.size()>specialRecommNum) {
//	// recommSpList=recommSpList.subList(0, specialRecommNum);
//	// }
//	// //按照专题列表加载即可
//	// for(CmsSpecial sp : recommSpList) {
//	//
//	// List<HCmsSpecialListVo> cmsSpecialVoList =
//	// cmsSpecialService.loadCmsSpecialListVoByParentId(
//	// new
//	// HCmsQueryDto().setSpecialId(sp.getSpecialId()).setMemberId(queryDto.getMemberId())
...
//	// dataListForcustomColumn=Lists.newArrayList();//专题数据容器
//	// if(customColumnIdList!=null&&customColumnIdList.size()>0) {
//	// for(Long customColumnId : customColumnIdList) {
//	// List<AppRecommConfigDto> appRecommConfigDtoList=
//	// recommAllLists.stream().filter(val->val.getColumnId().equals(customColumnId)).collect(Collectors.toList());
...
//	// cmsContentMng.cmsContentByColums(vo);
...
//	// //爆料数
//	// Integer count =
//	// snsFeignClient.queryTopicCountsByNewId(Long.valueOf(contents.get(k).get("contentId").toString()));
...
//	// List<Map<String, Object>> cons = new ArrayList<>();
//	// List<Map<String, Object>> contents =
//	// cmsContentMng.cmsContentByColum(Integer.parseInt(colums.get(i).get("columId").toString()),
//	// Integer.parseInt(colums.get(i).get("recommNum").toString()));
//	// if(contents!=null&&contents.size()>0) {
//	// for(int k = 0;k<contents.size();k++) {
//	// Map<String, Object> cn = new HashMap<>();
//	// cn.put("type", "1");
...
//	// snsFeignClient.cmsTopics(vo.getPageNo(),vo.getMemberId());
...
//	//// //查询专题(推荐)
//	//// List<Map<String, Object>> cmsCategorys =
//	// cmsCategoryMng.cmsCategoryNum();
//	//// if(cmsCategorys!=null&&cmsCategorys.size()>0) {
//	//// for(int i = 0;i<cmsCategorys.size();i++) {
//	//// List<Map<String, Object>> categorys =
//	// cmsCategoryMng.cmsCategorys(Integer.parseInt(cmsCategorys.get(i).get("recommNum").toString()));
//	//// //栏目下的新闻查询
//	//// if(categorys!=null&&categorys.size()>0) {
//	//// for(int k = 0;k<categorys.size();k++) {
//	//// List<Map<String, Object>> catContents =
//	// cmsCategoryMng.cmsContentByCatId(Integer.parseInt(categorys.get(k).get("categoryId").toString()),
//	// 3);
//	//// if(catContents!=null&&catContents.size()>0) {
//	//// for(int z=0;z<catContents.size();z++) {
//	//// Integer count =
//	// snsFeignClient.queryTopicCountsByNewId(Long.valueOf(catContents.get(z).get("contentId").toString()));
...
//	////// List<Map<String, Object>> cts =
//	// cmsContentMng.cmsContentByColum(Integer.parseInt(defColumn.get(i).get("columId").toString()),
//	// vo.getPageNo());
//	////// if(cts!=null&&cts.size()>0) {
//	////// for(int k = 0;k<cts.size();k++) {
//	////// Integer count =
//	// snsFeignClient.topicCountByContentId(Long.valueOf(cts.get(k).get("contentId").toString()));
...
//	// hql.append(" and content like :content").setParam("content", "%" +
//	// cmsContentDto.getContent() + "%");
//	// }
//	// hql.append(" order by releaseTime desc");
//	// Pagination p = cmsContentMng.find(hql, cmsContentDto.getPageNo(),
//	// cmsContentDto.getPageSize());
//	// if (p.getList() != null) {
//	// List<CmsContentDto> cmsContentDtos = BeanMapper.mapList(p.getList(),
//	// CmsContentDto.class);
...
//	//// boolean flag = cmsMemberBehaviorService.validateNewKeywordsExist(vo,
//	// cmsContentVo);
//	//// if (!flag) {
...
//	// {
//	// AppBehaviorDto appBehaviorDto=new
//	// AppBehaviorDto().setMemberId(vo.getUserId()).setBevValueStr("5,6,7");
//	// List<Long>
//	// contentIds=null;//appFeignClient.loadContentidsInMuiltType(appBehaviorDto);
//	// List<CmsContent> cmsContentList =
//	// cmsContentMng.queryPromoteNewsByPage(contentIds, vo);
//	// if (null == cmsContentList || cmsContentList.size() == 0) {
//	// return null;
//	// }
//	// List<CmsContentVo> list = BeanMapper.mapList(cmsContentList,
//	// CmsContentVo.class);
//	// return list;
//	// }
//
...
//	// //用户行为类别0 详情查看， 1点赞 ，2 收藏，3评论，4爆料，5 不感兴趣，6内容太水，7看过了
//	// List<Long>
//	// contentIds=appFeignClient.loadContentidsInMuiltType(vo.getUserId(),
//	// "8,10,12");
//	//
//	//
...
//	// }
//
//	// private void putSnsPostListAndPostCounts(QueryContentVo vo,
//	// CmsContentDataVo cmsContentDataVo) {
...
//	// UCenterFollow concern = userFeignClient.isConcern(svo.getMemberId(),
//	// vo.getUserId());
...
//	// Integer newsPostCounts = (null == snsPostVoList || snsPostVoList.size()
//	// == 0) ? 0 : snsPostVoList.size();
//	// cmsContentDataVo.setNewsPostCounts(newsPostCounts);
//	// }
//
//	// private void putSnsTopicListAndTopicCounts(HCmsQueryDto cmsQueryDto,
//	// CmsContentDataVo cmsContentDataVo) {
//	// List<SnsTopicVo> snsTopicList = new ArrayList<SnsTopicVo>();
//	//
//	// if(cmsContentDataVo.getContentId()!=null) {
//	// HBaseSnsQueryDto
//	// snsQueryDto=HBaseSnsQueryDto.newForNewsQuery(cmsQueryDto.getContentId(),
//	// cmsQueryDto.getUserId());
//	// snsTopicList = snsFeignClient.newsTpoicList(snsQueryDto);
//	//
...
//	// HUCenterFollowDto concern =
//	// userFeignClient.isConcern(topicVo.getMemberId(),
//	// cmsQueryDto.getUserId());
//	// if (concern != null && concern.getConcernType() != null) {
...
//	// Integer topicCounts = (null == snsTopicList || snsTopicList.size() == 0)
//	// ? 0 : snsTopicList.size();
//	// cmsContentDataVo.setTopicCounts(topicCounts);
//	// }
//	// 新闻爆料
//	// private void putSnsTopicCountsForContent(QueryContentVo vo, CmsContentVo
//	// cmsContentVo) {
//	// if(cmsContentVo.getContentId()!=null) {
//	// List<SnsTopicVo> snsTopicList =
//	// snsFeignClient.newTopics(cmsContentVo.getContentId(), vo.getUserId(),
//	// vo.getImei());
//	// Integer topicCounts = (null == snsTopicList || snsTopicList.size() == 0)
//	// ? 0 : snsTopicList.size();
...
//	// }
//
//	// private void putThumbFileInfoList(CmsContentData cmsContentData,
//	// CmsContentDataVo cmsContentDataVo) {
...
//	// * 收藏、点赞标识
//	// */
//	// private void putTimeStrAndSomeFlag(QueryContentVo vo,CmsContentDataVo
//	// cmsContentDataVo) {
//	//
//	// boolean collectionFlag =
//	// cmsMemberBehaviorService.queryNewCollectionFlag(vo.getContentId(),
//	// vo.getUserId(), vo.getImei());
//	// cmsContentDataVo.setCollectionFlag(collectionFlag);
//	// boolean followFlag =
//	// cmsMemberBehaviorService.queryNewFollowFlag(vo.getContentId(),
//	// vo.getUserId(), vo.getImei());
//	// cmsContentDataVo.setFollowFlag(followFlag);
//	// }
//	// private void putAbountNewsList(CmsContent cmsContent, CmsContentDataVo
//	// cmsContentDataVo) {
...
//	// List<CmsContent> abountNewList = (List<CmsContent>)
//	// cmsContentMng.find(f);
//	// cmsContentDataVo.setCmsContentList(abountNewList);
//	// } else {
...
//	// Integer count =
//	// snsFeignClient.queryNewPostFollowCount(cmsContentDataVo.getContentId());
//	// cmsContentDataVo.setNewPostFollowCounts(count);
//	// }
//	// private void putNewFollowCounts(CmsContentData cmsContentData,
//	// CmsContentDataVo cmsContentDataVo) {
//	// Integer newPostFollowCounts =
//	// cmsMemberBehaviorService.queryNewFollowCounts(cmsContentData.getContentId());
//	// cmsContentDataVo.setNewsFollowCounts(newPostFollowCounts);
//	// }
//
//	// private void putSnsPostCounts(QueryContentVo vo, CmsContentVo
//	// cmsContentVo) {
//	// SnsPostVo snsPostVo = new SnsPostVo();
...
//	// }
//
//	// private CmsContentDataVo buildCmsContentDataVo(CmsContentData
//	// cmsContentData) {
//	// CmsContentDataVo cmsContentDataVo = new CmsContentDataVo();
//	// try {
//	// BeanUtils.copyProperties(cmsContentDataVo, cmsContentData);
...
//	// List<CmsContentData> cmsContentDataList = (List<CmsContentData>)
//	// cmsContentDataMng.find(hql);
...
//	// List<CmsContent> cmsContentList = (List<CmsContent>)
//	// cmsContentMng.find(finder);
//	// if (null == cmsContentList || cmsContentList.size() == 0) {
//	// return null;
//	// }
...
//	//// //查询新闻列表
//	//// List<CmsContentVo> list = buildOtherNewList(vo, categoryIds,
//	// contentIds);
//	//// if (null == list || list.size() == 0) {
//	//// return null;
//	//// }
...
//	// Integer count =
//	// snsFeignClient.queryTopicCountsByNewId(cms.getContentId());
//	// cms.setTopicCounts(count);
//	// }
//	// return list;
//	// }
//
//	// private List<CmsContentVo> buildOtherNewList(QueryContentVo vo,
//	// List<Long> categoryIds, List<Long> contentIds) {
//	// List<CmsContent> cmsContentList = buildCmsContentPageListByCategory(vo,
//	// categoryIds, contentIds);
//	// List<CmsContentVo> list = BeanMapper.mapList(cmsContentList,
//	// CmsContentVo.class);
//	// return list;
//	// }
//
//	// private List<CmsContent> buildCmsContentPageListByCategory(QueryContentVo
//	// vo, List<Long> categoryIds, List<Long> contentIds) {
//	// List<CmsContent> list = cmsContentMng.queryCmsContentPageList(vo,
//	// categoryIds, contentIds);
//	// return list;
//	// }
//
//	// private List<Long> buildCmsColumnCategoryList(QueryContentVo vo) {
//	// List<CmsColumnCategory> cmsColumnCategoryList =
//	// cmsColumnCategoryDao.queryCmsColumnCategoryList(vo);
...
//
//	// @Override
//	// public List<SnsTopicVo> newTopicList(Long newId, Long userId, String
//	// imei) {
...
//	// UCenterFollow concern = userFeignClient.isConcern(snsTopic.getMemberId(),
//	// userId);
//	// if (concern != null && concern.getConcernType() != null) {
...
//	// UCenterFollow concern =
//	// userFeignClient.isConcern(snsPostVo.getMemberId(), vo.getMemberId());
//	// if (concern != null && concern.getConcernType() != null) {
...
//	// UCenterFollow concern =
//	// userFeignClient.isConcern(snsTopicVo.getMemberId(), vo.getMemberId());
//	// if (concern != null && concern.getConcernType() != null) {
...
//	// UCenterFollow concern = userFeignClient.isConcern(v.getMemberId(),
//	// vo.getMemberId());
//	// if (concern != null && concern.getConcernType() != null) {
...
//	// if (StringUtils.isNotEmpty(content) && content.contains(vo.getStr())) {
//	// String str = content.replaceAll(content, "<span color='red'>" + content +
//	// "</span>");
//	// topicVo.setContent(str);
//	// }
//	// if (StringUtils.isNotEmpty(title) && title.contains(vo.getStr())) {
//	// String str = title.replaceAll(title, "<span color='red'>" + title +
//	// "</span>");
...
//	// }
//	// vo.setIds(idList);
//	// List<UCenterMemberVo> UCenterMemberVoList =
//	// userFeignClient.searchMembers(vo);
...
//	// ElasticSearchPage<New> elasticSearchPage =
//	// elsFeignClient.searchVideos(vo);
//	// List<New> newList = elasticSearchPage.getRetList();
//	// if (null == newList || newList.size() == 0) {
//	// return null;
//	// }
...
//	// }
//	// ElasticSearchPage<New> elasticSearchPage =
//	// elsFeignClient.searchTopics(vo);
//	// List<New> newList = elasticSearchPage.getRetList();
//	// if (null == newList || newList.size() == 0) {
//	// return null;
//	// }
...
//	//
//	// return
//	// snsFeignClient.cmsNearPeoples(vo.getLongitude(),vo.getLatitude(),vo.getUmemberId());
//	// }
//
//	// @Override
