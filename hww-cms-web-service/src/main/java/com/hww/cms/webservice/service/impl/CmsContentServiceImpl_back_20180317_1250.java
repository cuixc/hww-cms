...
//@Service("cmsContentService20180317")
//@Transactional
//public class CmsContentServiceImpl_back_20180317_1250 implements CmsContentService {
//
//	private static final Log log = LogFactory.getLog(CmsContentServiceImpl_back_20180317_1250.class);
//
//	@Autowired
...
//			cmsContentDataVo.setHiddenMap(cmsContent.getHiddenMap());
//		}
//		Long memberId = cmsQueryDto.getMemberId();
//
//		constructCmsContentDataVoForDetail(cmsContentDataVo, cmsContent, memberId);
...
//		 * 
//		 * for (Long cmsContentId : topicVoIdList) { CmsContentData cmsDataFromSns =
//		 * cmsContentCacheProxyService.loadCmsContentDataById(cmsContentId); if
//		 * (cmsDataFromSns != null) {
//		 * topicVoIdList_2.add(cmsDataFromSns.getSnsOrginId());
//		 * dataContainer.put(cmsDataFromSns.getSnsOrginId(), cmsDataFromSns); } }
//		 * 
//		 * // 加载新鲜事 HBaseSnsQueryFeginApiDto queryFeginApiDto = new
//		 * HBaseSnsQueryFeginApiDto().setMemberId(queryDto.getMemberId())
//		 * .setImei(queryDto.getImei()).setLatitude(queryDto.getLatitude()).setLongitude(queryDto.getLongitude())
//		 * .setTopicIds(topicVoIdList_2);
//		 * 
//		 * // vo.getContentId() List<SnsTopicVo> recommTopicHisList =
//		 * snsFeignClient.loadTopicByIdsFeginApi(queryFeginApiDto); for (SnsTopicVo vo :
//		 * recommTopicHisList) { CmsContentData cmsDataFromSns =
//		 * dataContainer.get(vo.getTopicId()); vo.setTitle(cmsDataFromSns.getContent());
//		 * vo.setContent(cmsDataFromSns.getContent()); Map<String, Object> topicVoItem =
//		 * Maps.newHashMap(); topicVoItem.put("type", "3"); topicVoItem.put("content",
//		 * vo); dataSource.add(topicVoItem); } log.debug("FFFFFF===dataSource:" +
//		 * String.join(",", dataSource.stream() .map(val -> "" + ((CmsContentVo)
//		 * val.get("content")).getContentId()).collect(Collectors.toList())));
//		 **/
//		return dataSource;
//	}
...
//				CmsOrigin origin = cmsOriginMng.getCmsOringByContentId(cmsContentVo.getContentId());
