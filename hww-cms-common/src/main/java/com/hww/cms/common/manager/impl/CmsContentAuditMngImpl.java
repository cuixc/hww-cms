...
public class CmsContentAuditMngImpl extends BaseEntityMngImpl<Long, CmsContentAudit, CmsContentAuditDao>
	...
	@Override
	public List<CmsContent> getMyAuditContent(CmsContentVo vo, String roleIds) {
		...
		String s =null;
		 ...
		 s = "select cms_content.* " 
				...
				+ "and cms_content_audit_flow_steps.status>0 and cms_content_audit_flow_steps.role_id in (" + roleIds + ") "
	...
	@Override
	public Long getMyAuditContentCount(CmsContentVo vo, String roleIds) {
		String s =null;
if(vo.getCategoryId()==null) {
