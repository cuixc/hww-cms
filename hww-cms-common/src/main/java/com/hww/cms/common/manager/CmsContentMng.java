...
//	List<CmsContent> loadCmsContentByContentType(HCmsQueryDto cmsQueryDto, List<Long> uninterestedContentIds);
	...
	CmsContentDto findOneByContentIdForService(Long contentId);
	...
	boolean setCmsPriority(Long contentId,Integer priority);


	boolean setCmsStatus(Long contentId, Short status);
